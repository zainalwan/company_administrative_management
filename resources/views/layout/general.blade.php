	...
	<body>
		<nav>
			<ul>
				...
				<li class="{{ (!preg_match('/(event)|(announcement)|(employee)|(account)/', url()->current())) ? 'active' : false }}">
				...
				<li class="{{ preg_match('/event/', url()->current()) ? 'active' : false }}">
				...
				<li class="{{ preg_match('/announcement/', url()->current()) ? 'active' : false }}">
					<a href="/announcement"><svg width="1em" height="1em" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
						<path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
					</svg></a>
					<a href="/announcement">Announcement</a>
				</li>
				<li class="{{ preg_match('/employee/', url()->current()) ? 'active' : false }}">
				...
				<li class="{{ preg_match('/account/', url()->current()) ? 'active' : false }}">
